...
class ServiceCar(models.Model):
    ...
    model = models.ForeignKey('ServiceCarmodel', models.DO_NOTHING, blank=True, null=True)
    client = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
    note = models.TextField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'service_car'


class ServiceCarmodel(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'service_carmodel'


class ServiceOrder(models.Model):
    date = models.DateField(blank=True, null=True)
    car = models.ForeignKey(ServiceCar, models.DO_NOTHING, blank=True, null=True)
...
class ServiceOrderentry(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=5, blank=True, null=True)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    order = models.ForeignKey(ServiceOrder, models.DO_NOTHING, blank=True, null=True)
    service = models.ForeignKey('ServiceService', models.DO_NOTHING, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'service_orderentry'


class ServiceOrderreview(models.Model):
    reviewed_at = models.DateTimeField()
    content = models.TextField()
    order = models.ForeignKey(ServiceOrder, models.DO_NOTHING)
    reviewer = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'service_orderreview'
